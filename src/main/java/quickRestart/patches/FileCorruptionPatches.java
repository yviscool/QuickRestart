...
import static quickRestart.helper.RestartRunHelper.queuedSnapshotRestart;
...
public class FileCorruptionPatches {
    ...
    public static class SaveSynchronuslyPls {
        ...
        public static void patch(@ByRef boolean[] enableAsyncSave) {
            // Save synchronously when we need a fresh snapshot on disk immediately.
            if (queuedScoreRestart || queuedRestart || queuedSnapshotRestart || RoomSnapshotHelper.forceSyncSave) {
